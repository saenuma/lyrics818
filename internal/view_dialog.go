...
func DrawDialogWithMessage(window *glfw.Window, currentFrame image.Image, msg string) {
	...
	ggCtx.DrawString(msg, float64(dialogOriginX)+20, float64(dialogOriginY)+20+20)
