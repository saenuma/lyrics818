...
// Lyrics  Video Upon Slideshow
func Method2(outName string, totalSeconds int, renderPath string, conf zazabul.Config) {
	...
	MakeSlideshowFrames("frames_"+outName, totalSeconds, framesPath, conf)
